...
namespace TuneVault.Infrastructure.Repositories
{
    public class AlbumRepository : IAlbumRepository
    {
        ...
        {
            string sql = @"SELECT * FROM TuneValt.Album WHERE AlbumID = @AlbumID AND IsDeteled = 0";
        ...
        {
            string sql = @"SELECT * FROM TuneValt.Album WHERE Artist = @Artist AND IsDeteled = 0";
        ...
        {
            string sql = @"INSERT INSERT INTO TuneVault.Album 
        ...
        {
            string sql = @"UPDATE TuneVault.Album 
