...
GetProfileQuery
  -> ValidationBehavior            % Bỏ qua FluentValidation 
...
UpdateProfileCommand
  ...
  -> int                           % Trả về số dòng bị ảnh hưởng trong database 
Mô tả:
...
CreatePlaylistCommand
  -> CreatePlaylistValidator       % Xác thực thông tin đầu vào 
...
GetNotificationsQuery
  ...
  -> IEnumerable<NotificationDto>  % Trả về danh sách thông báo kèm payload chi tiết 
