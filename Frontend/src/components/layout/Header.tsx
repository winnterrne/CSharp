...
export interface HeaderUser {
  displayName: string;   // dùng để lấy chữ cái đầu cho avatar
  avatarUrl?: string;    // URL ảnh avatar tuỳ chọn
  avatarColor?: string;  // màu nền avatar fallback
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Search Icon */}
          <svg width="16" height="16" viewBox="0 0 24 24" fill="#b3b3b3" style={{ flexShrink: 0 }}>
          ...
          {/* Divider + Browse icon */}
          <div style={{ width: "1px", height: "20px", background: "#666", flexShrink: 0 }} />
          <button
...
// ─── Icon Action Button (internal helper) ─────────────────────────────────────
const IconActionBtn = ({
  children,
  title,
  onClick,
